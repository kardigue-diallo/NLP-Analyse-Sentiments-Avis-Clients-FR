...
[![Démo en ligne](https://img.shields.io/badge/DÉMO_EN_LIGNE-ST-FF4B4B?style=for-the-badge&logo=streamlit&logoColor=white)](https://nlp-analyse-sentiments-avis-clients-fr.streamlit.app)
...
* **Routage Métier Automatisé :**
  * **Avis Négatif (Confiance $\ge 45\%$ )** $\rightarrow$ **Priorité Haute** (Transfert support immédiat & alerte).
  * **Avis Négatif (Confiance $< 45\%$ )** $\rightarrow$ **Priorité Moyenne** (E-mail d'excuses automatique).
